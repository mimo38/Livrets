...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%
	\rubrica{Puis l'on chante le psaume 69.}
	\vulgo{%
	...
	\textbf{\R~Deus meus, sperántes in te.}}{%
	\V~Sauvez vos serviteurs,
	
	\textbf{\R~Qui espèrent en vous, mon Dieu.}%
	}
	...
	\textbf{\R~En face de l'ennemi.}%
	}
	
	\traduire{%
	\V~Nihil profíciat inimícus in nobis.
	
	\textbf{\R~Et fílius iniquitátis non appónat nocére nobis.%
	}}{%
	\V~Que l'ennemi n'ait aucune emprise sur nous.
	
	\textbf{\R~Et que le fils d'iniquité n'ose point nous nuire.%
	}}
	
	\traduire{%
	\V~Dómine, non secúndum peccáta nostra fácias nobis.
	
	\textbf{\R~Neque secúndum iniquitátes nostras retríbuas nobis.%
	}}{%
	\V~Seigneur, ne nous traitez pas selon nos fautes.
	
	\textbf{\R~Et ne nous châtiez pas selon nos iniquités.%
	}}
	
	\traduire{%
	\V~Orémus pro Pontífice nostro \emph{N}.
	
	\textbf{\R~Dóminus consérvet eum, et vivíficet eum \+, et beátum fáciat eum in terra \*, et non tradat eum in ánimam inimicórum eius.%
	}}{%
	\V~Prions pour notre Pontife \emph{N}.
	
	\textbf{\R~Que le Seigneur veille sur lui, lui garde la vie et fasse son bonheur sur terre, empêchant qu'il ne tombe à la merci de ses ennemis.}
	}
	\traduire{%
	\V~Orémus pro benefactóribus nostris.
	
	\textbf{\R~Retribúere dignáre, Dómine \+, ómnibus nobis bona faciéntibus propter nomen tuum \*, vitam ætérnam. Amen.}}{%
	\V~Prions pour nos bienfaiteurs.
	
	\textbf{\R~Daignez, Seigneur, donner la vie éternelle en récompense à tous ceux qui nous ont fait du bien en l'honneur de votre Nom. \ainsi}
	}
	\traduire{%
	\V~Orémus pro ómnibus fidélibus defúnctis.
	
	\textbf{\R~Réquiem ætérnam dona eis, Dómine \*, et lux perpétua lúceat eis.}}{%
	\V~Prions pour tous les fidèles défunts.
	
	\textbf{\R~Donnez leur, Seigneur, le repos éternel, et que la lumière sans fin resplendisse à leurs yeux.}}
	...
	\textbf{\R~Salvos fac servos tuos, \* Deus meus, sperántes in te.}}{%
	\V~Pour nos frères absents.
	
	\textbf{\R~Protégez, mon Dieu, vos serviteurs qui espèrent en vous.}
	}
	\traduire{%
	...
	\textbf{\R~Et de Sion, protégez-les.}}
