...
\versio{Ego conjungo vos in matrimonium, in nomine Patri, et Filii~\x\ et Spiritui Sancti. Amen.}{Je vous déclare unis par le mariage au nom du Père et du Fils~\x\ et du Saint Esprit. Ainsi soit-il.}
...
\versio{\V Adiutorium nostrum in nomine Domini.}{\V Notre secours est dans le nom du Seigneur.}

\versio{\R \textbf{Qui fecit c\ae lum et terram.}}{\R \textbf{Qui a fait le ciel et la terre.}}
...
\versio{\R \textbf{Amen.}}{\R \textbf{Ainsi soit-il.}}
...
\rubrica{Le Célébrant, avant de lire l'antienne d'Introït, bénit l'encens, en disant :}
\versio{%
...
\versio{Kyrie eleison \emph{(ter)}}{Seigneur ayez pitié de nous \emph{(ter)}}
\versio{Christe eleison \emph{(ter)}}{Christ ayez pitié de nous \emph{(ter)}}
\versio{Kyrie eleison \emph{(ter)}}{Seigneur ayez pitié de nous \emph{(ter)}}
...
\titre{Graduel}
\rubrica{Graduel, Alléluia sont des chants de méditation sur les lectures ou le mystère liturgique de ce jour. \emph{Alleluia} signifie "louez Dieu". L'Alléluia se prolonge dans une mélodie ornée qui exprime la joie spirituelle au-delà des paroles. C'est pourquoi le Graduel est remplacé au temps pascal par un deuxième Alléluia, alors que le Trait remplace l'Alléluia depuis la Septuagésime jusqu'à Pâques.}

\versio{Uxor tua sicut vitis abundans in lateribus domus tuae. \V Filii tui sicut novellae olivarum in circuitu mensae tuae}{Ton épouse sera comme une treille chargée de grappes sur les murs de ta maison. \V Tes enfants, autour de la table, comme des jeunes pousses d'olivier.}

\titre{Alléluia}
\versio{Alleluia, Alleluia. \V Mittat vobis Dominus auxilium de sancto : et de Sion tueatur vos. Alleluia.}{Alléluia, Dieu soit loué ! Que le Seigneur vous envoie du secours de son temple saint ; et qu'il vous protège du haut de la colline de Sion.}

\titre{Évangile}

\rubrica{On chante le saint Évangile tourné vers le Nord (le ch\oe ur étant normalement orienté vers l'Est) parce que le Nord symbolise les âmes qui se trouvent dans la froideur de l'infidélité et de l'ignorance du Christ, et qui sont éveillées par le souffle du Saint-Esprit.}
...
Orémus.}{%
Prions.}
\versio{In te speravi, Domine : dixi : Tu es Deus meus : in manibus tuis tempora mea.}{En vous, Seigneur, je mets toute ma confiance ; aussi ai-je dit : Vous êtes mon Dieu, ma destinée est entre vos mains.}
...
\vulgo{\textit{Tout de suite après le \emph{Pater}, le prêtre se tourne vers les nouveaux mariés et lit en latin les oraisons suivantes~:}}
...
\versio{\R\textbf{Amen.}}{\R \textbf{\ainsi.}}
...
\versio{Agnus Dei, qui tollis peccáta mundi, dona nobis pacem.%
}{%
...
\versio{Ecce sic benedicetur omnis homo qui timet Dominum : et videas filios filiorum tuorum : pax super Israël}{Voilà comment sera béni tout homme qui craint le Seigneur. Puisses-tu voir les enfants de tes enfants ! Que la paix soit sur Israël ! Alléluia.}
...
\vulgo{Voilà comment sera béni tout homme qui craint le Seigneur. Puisses-tu voir les enfants de tes enfants ! Que la paix soit sur Israël ! Alléluia.}
...
\vulgo{\textit{Ayant dit \emph{Ite, missa est}, le prêtre bénit les nouveaux époux.}}
\versio{%
...
\pagebreak[3]
\cantus{Hymne}{TeDeum}{8.}

\rubrica{Pendant la procession de sortie, nous chantons le chant suivant :}
...
\rubrica{Suit ensuite la consécration des nouveaux époux à Notre Dame. Pendant la signature des registres, nous prenons le chant qui suit : }
